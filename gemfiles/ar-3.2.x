...
gem "mysql2", '~> 0.2.18', platforms: [:ruby_20]
...
gem "rake", "~> 11"
gem "reek", "~> 2.2.1", platforms: [:mri_19, :mri_20, :mri_21]
gem "roodi", "~> 5", platforms: [:mri_19, :mri_20, :mri_21]
gem "coveralls", platforms: [:mri_19, :mri_20, :mri_21]
